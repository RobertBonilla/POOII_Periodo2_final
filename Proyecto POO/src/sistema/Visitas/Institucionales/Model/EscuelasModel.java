...
public class EscuelasModel {
    ...
    public ArrayList<EscuelaForm> cosultarEscuelas(){
        ArrayList<EscuelaForm> listEscuela = new ArrayList<>();
        try{
            Statement cmd = this.cn.createStatement();
            ResultSet rs =cmd.executeQuery("SELECT e.id,e.nombre,e.facultad from escuelas e");            
